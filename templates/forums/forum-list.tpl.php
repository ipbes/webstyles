 ...
 * @ingroup themeable
 */
if(arg(0) == 'forum' && arg(1)==14960){

?>
<div class="forums-onet-page" id="forum-<?php print $forum_id; ?>">
  <div>
  <?php foreach ($forums as $child_id => $forum): ?>
    <div id="forum-list-<?php print $child_id; ?>" class="forum-list-row <?php print $forum->zebra; ?>">
      <div <?php print $forum->is_container ? 'colspan="4" class="container"' : 'class="forum"'; ?>>
      ...
      <?php if (!$forum->is_container): ?>
        <div class="topics">Topics : 
          <span class="topic-tag"><?php print $forum->num_topics ?></span>
          <?php if ($forum->new_topics): ?>
            <br />
            <a href="<?php print $forum->new_url; ?>"><?php print $forum->new_text; ?></a>
          <?php endif; ?>
        </div>
        <div class="posts">Posts : <span class="topic-tag"><?php print $forum->num_posts ?></span></div>
        <div class="last-reply">Last Post by : <span class="topic-tag"><?php print $forum->last_reply ?></span></div>
      <?php endif; ?>
    </div>
  <?php endforeach; ?>
  </div>
