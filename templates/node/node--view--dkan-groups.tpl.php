...
<?php if ($teaser): ?>
  ...
  ?>
  <article class="node-teaser group-node">
    ...
    <div class="content">
      <p>
        <?php $teaser = field_view_field('node', $node, array(
            'label' => 'hidden',
    ...
    <a href="<?php print urldecode($node_url) ?>" class="btn-group"><?php print count($datasets) ?> datasets</a>
  </article>
